function createUnityInstance(e, t, r) {
    function n(e, t, r) {
        ...
        if (!(u.errorHandler && u.errorHandler(e, t, r) || (console.log("Invoking error handler due to\n" + e), "function" == typeof dump && dump("Invoking error handler due to\n" + e), e.indexOf("UnknownError") != -1 || e.indexOf("Program terminated with exit(0)") != -1 || n.didShowErrorMessage))) {
    ...
    function s(e) {
        return new Promise(function(t, r) {
            a(e);
            var n = u.companyName && u.productName ? new u.XMLHttpRequest({
                companyName: u.companyName,
                productName: u.productName,
                cacheControl: u.cacheControl(u[e])
            }) : new XMLHttpRequest;
            n.open("GET", u[e]), n.responseType = "arraybuffer", n.addEventListener("progress", function(t) {
                a(e, t)
            }), n.addEventListener("load", function(r) {
                a(e, r), t(new Uint8Array(n.response))
            }), n.send()
        })
    }
    ...
    return u.SystemInfo = function() {
        ...
        u.SystemInfo.hasWebGL ? u.SystemInfo.hasWasm ? (1 == u.SystemInfo.hasWebGL && u.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), u.startupErrorHandler = t, r(0), u.postRun.push(function() {
            r(1), delete u.startupErrorHandler, e(c)
